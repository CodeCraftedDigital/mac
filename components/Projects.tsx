              ...
              <div className="relative rounded-lg overflow-hidden shadow-lg">
                <div className="grid grid-cols-2">
                  ...
                  <div className="relative h-32">
                    ...
                    />
                    <div className="absolute top-2 left-2 px-2 py-0.5 bg-black/80 text-white text-[10px] font-bold uppercase rounded">
                      Before
                    </div>
                  </div>
                  {/* After */}
                  <div className="relative h-32">
                    <Image
                      ...
                      className="object-cover"
                    />
                    <div className="absolute top-2 right-2 px-2 py-0.5 bg-primary text-white text-[10px] font-bold uppercase rounded">
                      After
                    </div>
                  </div>
                </div>
